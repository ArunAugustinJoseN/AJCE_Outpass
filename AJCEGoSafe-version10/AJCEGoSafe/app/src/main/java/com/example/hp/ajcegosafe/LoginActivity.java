            ...
            public void onClick(View v) {
                ...
                if(et.getText().toString().trim().length()==0 && et1.getText().toString().trim().length()==0){
                    ...
                    try {
                        ...
                        value2.put(dbHelp.ADNO3, adno);
                        value2.put(dbHelp.ROLE_ID, rid);

                        db2.insert(dbHelp.TABLE_START, null, value2);
                        db2.close();
                        ...
                        else if (cur.getCount() != 0 && rid == 1) {
                            Intent intent = new Intent(LoginActivity.this, SecuritiesHome.class);
                            startActivity(intent);
                            et.setText("");
                            et1.setText("");
                            error.setText("");
