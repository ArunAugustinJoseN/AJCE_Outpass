...
class DB_Functions {
 ...
 /**
     * Get student information for admin Outpass varification
     */
    public function getStudentOutpassProfile($admno, $oid) {
 
        $stmt = $this->conn->prepare("SELECT * FROM table_studentinfo, table_outpass WHERE table_outpass.outpass_id = ? AND table_studentinfo.admission_no = table_outpass.admission_no");
