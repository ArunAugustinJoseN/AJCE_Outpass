...
/* Batch Table */
    ...
    /* creating tables */
        ...
        String PROFILE_TABLE = "CREATE TABLE "+ TABLE_NAME +" ("+ ID +" INTEGER PRIMARY KEY AUTOINCREMENT, "+ LOGID +" INT NOT NULL, "+ BID2 +" INT NOT NULL, " +
                ""+ NAME +" TEXT NOT NULL, "+ DOB +" DATE NOT NULL, "+ GEN +" TEXT NOT NULL, "+ YEAR +" TEXT NOT NULL, "+ STNO +" INT NOT NULL, "+ PTNO +
 ...
 /* insert data into Role table */
  ...
  /* insert batch values */
    public void insertBatch(){
        SQLiteDatabase db=this.getWritableDatabase();
        String query20 = " INSERT INTO "+TABLE_BATCH+ " ("+BRID2+","+BNAME+") VALUES('1','Batch');";
        db.execSQL(query20);
        String query21 = " INSERT INTO "+TABLE_BATCH+ " ("+BRID2+","+BNAME+") VALUES('2','Batch');";
        db.execSQL(query21);
        String query22 = " INSERT INTO "+TABLE_BATCH+ " ("+BRID2+","+BNAME+") VALUES('3','Batch');";
        db.execSQL(query22);
