...
/* display list of names from student profile table */
    ...
    /* display list of outpass history details of all students from outpass table */
    public Cursor getOutpassHistoryAdmin() {

        SQLiteDatabase db=this.getWritableDatabase();
        Cursor data = db.rawQuery("select "+TABLE_NAME1+"."+DATE+","+TABLE_NAME1+"."+PUR+","+TABLE_NAME1+"."+STATUS
                +","+TABLE_NAME+"."+ADNO2+","+TABLE_NAME1+"."+OID+" from "+TABLE_NAME1+","+TABLE_NAME+" WHERE "+TABLE_NAME+"."+ID+" = "
                +TABLE_NAME1+"."+PID+" ORDER BY "+OID+" DESC", null);
        return data;
    }
    ...
    public void changeStatusToThree( int oid,String time){

        String selectQuery = "UPDATE "+TABLE_NAME1+ " SET "+TOL+" = '"+time+"',"+STATUS+" = 3 WHERE "+OID+" = "+oid;
    ...
    public void changeStatusToFour( int oid ,String time){

        String selectQuery = "UPDATE "+TABLE_NAME1+ " SET "+TOR+" = '"+time+"',"+STATUS+" = 4  WHERE "+OID+" = "+oid;
    ...
    /* change status value into 4 in outpass table */
    public void changeStatusToFive( int oid ,String time){

        String selectQuery = "UPDATE "+TABLE_NAME1+ " SET "+TOR+" = '"+time+"',"+STATUS+" = 5  WHERE "+OID+" = "+oid;
