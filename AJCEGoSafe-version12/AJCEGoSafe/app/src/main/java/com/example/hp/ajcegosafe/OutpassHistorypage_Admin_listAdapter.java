...
public class OutpassHistorypage_Admin_listAdapter extends ArrayAdapter<OutpassHistoryAdmin> {
    ...
    public View getView(int position, View convertView, ViewGroup parents) {
        ...
        if(outpassHistory != null){
            ...
            Integer count = Integer.parseInt(outpassHistory.getCount());
            if (txt_sno != null) {
                int pos = position+1;
            ...
            if (txt_oid != null) {
                txt_oid.setText((outpassHistory.getOid()));
            }

            txt_purpose.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Integer adno = Integer.parseInt(txt_adno.getText().toString());
                    String date = txt_date.getText().toString();
                    Integer oid = Integer.parseInt(txt_oid.getText().toString());
