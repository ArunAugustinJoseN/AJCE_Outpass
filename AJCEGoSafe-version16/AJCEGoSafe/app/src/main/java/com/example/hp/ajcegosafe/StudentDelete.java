...
//            String query = "SELECT * from " + dbHelp.TABLE_NAME + " WHERE " + dbHelp.NAME + "='" + s_name + "'";
//            Cursor c = db.rawQuery(query, null);
//            if (c.getCount() == 1) {
//                c.moveToFirst();
//                String adno = c.getString(c.getColumnIndex(dbHelp.ADNO2));
//                String name = c.getString(c.getColumnIndex(dbHelp.NAME));
//                Integer bid = c.getInt(c.getColumnIndex(dbHelp.BID2));
//                String yr = c.getString(c.getColumnIndex(dbHelp.YEAR));
//                db.close();
//
...
//                Cursor c1 = db2.rawQuery(query1, null);
//                c1.moveToFirst();
//                String batch = c1.getString(c1.getColumnIndex(dbHelp.BNAME));
//                db2.close();
//
//                et.setText(adno);
//                tv1.setText(name);
