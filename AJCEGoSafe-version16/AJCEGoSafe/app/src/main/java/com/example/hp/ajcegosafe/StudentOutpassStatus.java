            ...
            public void onResponse(String response1) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        AbsoluteLayout layout=(AbsoluteLayout) findViewById(R.id.absLayout);


                        Integer status = Integer.parseInt(st);
                        if (status == 0){
                            t1.setText("Requested");
                            t1.setBackgroundResource(R.drawable.pooram);
                            t1.setTextColor(Color.parseColor("#FFFFFF"));
                        }
                        else if (status == 1){
                            t1.setBackgroundResource(R.drawable.approved);
                        }
                        else if (status == 2){
                            t1.setBackgroundResource(R.drawable.rejected);
                        }
                        else if (status == 3){
