            ...
            public void onResponse(String response1) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        String stream_id = student.getString("stream_id");
                        String branch_id = student.getString("branch_id");
//                        Toast.makeText(getApplicationContext(),
...
//                                +stream_id+"/"+branch_id, Toast.LENGTH_LONG).show();
                        ...
                        value.put(dbHelp.STREAM, stream_id);
                        value.put(dbHelp.BRANCH, branch_id);
                        dbH.insert(dbHelp.TABLE_STUDENT, null, value);
                        dbH.close();

                        // Calling stream and branch functions
                        getStream(stream_id);
                        getBranch(branch_id);
    ...
    /**
     * function to get stream of student
     * */
    private void getStream(final String stream_id) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_STREAM, new Response.Listener<String>() {
            ...
            public void onResponse(String response1) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        String stream_name = stream.getString("streams");

                        // Update stream name
                        db.updateStream(stream_name);
    ...
    private void getBranch(final String branch_id) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_BRANCH, new Response.Listener<String>() {
            ...
            public void onResponse(String response1) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        String branch_name = branch.getString("branches");

                        // Update stream name
                        db.updateBranch(branch_name);
